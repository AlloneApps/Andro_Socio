...
public class UserComplaintMainAdapter extends RecyclerView.Adapter<UserComplaintMainAdapter.UserComplaintAdapterViewHolder> {

    private static final String TAG = UserComplaintMainAdapter.class.getSimpleName();
    /**
    ...
    public UserComplaintMainAdapter(Context context, List<ComplaintMaster> complaintMasterList, UserComplaintItemClickListener listener) {
