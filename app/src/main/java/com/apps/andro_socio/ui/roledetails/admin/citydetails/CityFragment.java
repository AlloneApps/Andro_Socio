package com.apps.andro_socio.ui.roledetails.admin.citydetails;
...
public class CityFragment extends Fragment {
    ...
    private void checkAndCreateCity() {
        if (TextUtils.isEmpty(editAddNewCity.getText().toString().trim())) {
            AndroSocioToast.showErrorToastWithBottom(requireContext(), "Please enter city name", AndroSocioToast.ANDRO_SOCIO_TOAST_LENGTH_SHORT);
        } else {
            if (checkCityNotExists(editAddNewCity.getText().toString().trim())) {
                ...
                AndroSocioToast.showErrorToastWithBottom(requireContext(), "City already added", AndroSocioToast.ANDRO_SOCIO_TOAST_LENGTH_SHORT);
            }
        }
    }
            ...
            mCityReference.child(cityName).setValue(city)
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            hideProgressDialog();
                            AndroSocioToast.showSuccessToastWithBottom(requireContext(), "City created successfully.", AndroSocioToast.ANDRO_SOCIO_TOAST_LENGTH_LONG);
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            hideProgressDialog();
                            AndroSocioToast.showErrorToastWithBottom(requireContext(), "Failed to create city", AndroSocioToast.ANDRO_SOCIO_TOAST_LENGTH_SHORT);
                        }
                    });
        } catch (Exception e) {
            hideProgressDialog();
