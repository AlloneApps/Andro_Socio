...
public class AddressPlaceActivity extends AppCompatActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d(TAG, "onCreate: AddressPlaceActivity");
        ...
        if (!TextUtils.isEmpty(requestType)) {
            switch (requestType) {
                case AppConstants.LOCATION_SOURCE:
                    locationMarkerText.setText("Set Location");
                    break;
    ...
    private void initGooglePlacesApi() {
        ...
        Places.initialize(AddressPlaceActivity.this, getString(R.string.google_maps_api));
...
// Initialize Places.
        Places.initialize(getApplicationContext(), "AIzaSyAUC8qwlWKzruJW3XEgTHI7SrIzI6-wd5Q");
