...
public class ViewUserIssues extends Fragment implements UserIssueMainAdapter.UserIssueItemClickListener{
    private static final String TAG = ViewUserIssues.class.getSimpleName();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView =  inflater.inflate(R.layout.fragment_view_user_issues, container, false);
        return rootView;
    }
    ...
    private void setUpViews(){
        try {
            ...
            recyclerViewUserIssue.setAdapter(userIssueMainAdapter);
